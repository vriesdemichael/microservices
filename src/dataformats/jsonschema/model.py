...
class Draft4MetaSchema(BaseModel ):
    ...
    def derefence(self, download_external=False):
        ...
        if self.ref_ == "http://json-schema.org/draft-04/schema#" or self.ref_ == "http://json-schema.org/draft-04/schema":
    ...
    def resolve_pointer(self, pointer, download_external: bool = False) -> Self:
        ...
        try:
            ...
            raise ValueError(f"Exception of type {type(e)} encountered while trying to resolve '{self.json_pointer}/{pointer} {self=}'")from e
